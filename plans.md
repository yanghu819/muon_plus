...
| fast-variants-300-05138f72 | in_progress | Quickly cover the remaining top-level ideas with 300-step gates, then prune. | GPU2 queue launched from `05138f72`: Lite diag, Lite adaptive, Lite Trust, Lite qkv/c_fc mask, low-rank-16, sketch-64. | Promote only variants that beat the 300-step Lite/Muon anchor or reveal a clear mechanism. |
