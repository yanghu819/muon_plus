...
Use this as the actual same-horizon control if it completes. If final full
Trust is `<= 3.6895`, stop the temporal schedule. If full Trust is worse than
`3.6895`, promote one full-length Lite256->full Trust run, while noting that the
rerun used the restarted GPU2 A100 instance.
